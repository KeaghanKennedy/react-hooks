...
It's overkill, but I'm restating the fact here. The following code will not work. 
The useEffect hook cannot return anything other than it's synchronous cleanup
function. If you declare the callback function as async it will automatically 
return a promise, regardless of whether you're actually returniing anything.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Hooks%20%F0%9F%8E%A3&e=06%3A%20useEffect%3A%20HTTP%20requests&em=keaghan.kennedy%40gmail.comkeaghan.kennedy%40gmail.com).
